      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-10">
        ...
        <div>
          ...
          <div className="flex gap-4">
            <button className="bg-primary bg-blue-400 text-black px-6 py-3 rounded hover:opacity-80 transition-all duration-500 ease-in-out shadow-lg hover:shadow-xl">
              Add to Cart
            </button>
            <button className="border border-gray-600 px-6 py-3 rounded hover:bg-blue-400 hover:text-black transition-all duration-500 ease-in-out shadow-md hover:shadow-lg">
              More Details
            </button>
          </div>
        </div>
        ...
        <div className="relative">
          <img
            ...
            alt="Mouse"
            className="w-full max-w-lg mx-auto hover:scale-105 transition-all duration-500 ease-in-out"
          />
